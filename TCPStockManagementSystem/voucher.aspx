...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
     ...
     <div class="col-3">
         ...
         <asp:TextBox ID="AdvancePay" runat="server" Width="246px" class="form-control" BorderColor="#C48A05" BorderWidth="2px" AutoComplete="off"></asp:TextBox>
     </div>
     </div>
     <br />
     <div class="row">
     ...
     <div class="col-3">
         ...
         <asp:TextBox ID="txtTax" runat="server" Width="248px" class="form-control" BorderColor="#C48A05" BorderWidth="2px" AutoComplete="off"></asp:TextBox>
     </div>
     </div>
     <br />
     <div class="row">
