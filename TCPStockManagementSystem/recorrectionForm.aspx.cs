    ...
    public partial class recorrectionForm : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd04.CommandText = "select material,wash,netWeight from material where billId='" + billId + "'";
                ...
                if (rd.HasRows)
                {
                    if (rd.Read())
                    {
                        ...
                        netWeight = double.Parse(rd[2].ToString());
                    }
                }
                rd.Close();
                ...
                totalWeight = Math.Round((totalWeight - netWeight), 2);
