        ...
        <div class="card">
           ...
           <div class="card text-white bg-dark mb-3" style="max-width: 80%; margin-left:125px">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card border-danger mb-3" style="max-width: 18rem; margin-left:-200px">
                        <div class="card-header" style="color:black; font-weight:bold">Low EC</div>
                        <div class="card-body text-danger">
                            <h5 class="card-title" style="font-weight:bold"><asp:Label ID="cocoPeatLowEc" runat="server" Text="L"></asp:Label></h5>
                ...
                <div class="col-md-4">
                    <div class="card border-danger mb-3" style="max-width: 18rem; margin-left:-200px">
                        <div class="card-header" style="color:black; font-weight:bold">High EC</div>
                        <div class="card-body text-danger">
                            <h5 class="card-title" style="font-weight:bold"><asp:Label ID="cocoPeatHighEc" runat="server" Text="L"></asp:Label></h5>
                            <p class="card-text">Available in the Stock</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-4"></div>
                <div class="col-md-4">
                    <div class="card border-danger mb-3" style="max-width: 18rem; margin-left:-40px">
