    ...
    <div class="container-sm" style="margin-top:5px">
        ...
        <h5  class="card-header">Add number of kilo's used for daily production</h5>
            ...
            <div class="card" style="margin: -10px; padding: 8px; background-color: #FFFFCC" >
             ...
             <div class="row">
                <div class="col-md-3">
                    <asp:Label ID="Label1" runat="server" Text="Low-EC:" Font-Size="Large" Font-Bold></asp:Label>
                </div>
                <div class="col-md-3">
                ...
                <div class="row">
                    <div class="col-md-3">
                         <asp:Label ID="Label4" runat="server" Text="High-EC:" Font-Size="Large" Font-Bold></asp:Label>
                    </div>
                    <div class="col-md-2">
