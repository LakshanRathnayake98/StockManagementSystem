    ...
    public partial class CocoPeatreduct : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                cnn.Open();
                SqlCommand cmd2 = new SqlCommand("Select netWeight from stock where material='Coco-Peat' and wash='Low-EC'", cnn);
                SqlCommand cmd3 = new SqlCommand("Select netWeight from stock where material='Coco-Peat' and wash='Non-Wash'", cnn);
                SqlCommand cmd4 = new SqlCommand("Select netWeight from stock where material='Coco-Peat' and wash='High-EC'", cnn);
